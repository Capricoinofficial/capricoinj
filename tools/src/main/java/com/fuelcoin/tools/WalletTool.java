...
public class WalletTool {
    ...
    private static void setup() throws BlockStoreException {
        ...
        ValidHashStore hashstore;
        
        try{
        	hashstore = new ValidHashStore(new File("hashstore"));
        }
        catch(IOException e)
        {
        	throw new RuntimeException(e);
        ...
        if (mode == ValidationMode.SPV) {
            ...
            chain = new BlockChain(params, wallet, store, hashstore);
            ...
            store = s;
            chain = new FullPrunedBlockChain(params, wallet, s, hashstore);
        }
